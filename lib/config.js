...
const config = {
  ...
  googleCalendar: {
    // Auth OAuth classique (pas de clé de compte de service, pour éviter
    // les règles d'organisation Google Cloud qui bloquent leur création
    // sur les projets récents).
